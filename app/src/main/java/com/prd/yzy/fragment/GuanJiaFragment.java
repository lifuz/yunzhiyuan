...
import com.prd.yzy.gj.CaiGouActivity;
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            ...
            case R.id.gj_sc:
                ...
                startActivity(new Intent(getActivity(), ShengChanActivity.class));
                break;
            ...
            case R.id.gj_kc:
                ...
                startActivity(new Intent(getActivity(), KuCunActivity.class));
                break;
